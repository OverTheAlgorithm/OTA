...
type Config struct {
	...
	SitemapTopicMaxAgeDays int // SITEMAP_TOPIC_MAX_AGE_DAYS: topic age limit in days for sitemap inclusion and noindex logic; default 7
...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		SitemapTopicMaxAgeDays: getEnvInt("SITEMAP_TOPIC_MAX_AGE_DAYS", 7),
